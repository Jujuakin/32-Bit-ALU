...
#  Created by Genus(TM) Synthesis Solution 21.17-s066_1 on Thu Apr 10 21:08:15 EDT 2025
...
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports Din_R]
set_input_delay -clock [get_clocks clk] -add_delay 0.01 [get_ports Din_L]
...
set_max_fanout 5.000 [get_ports Din_L]
set_max_fanout 5.000 [get_ports Din_R]
...
set_drive 2.0 [get_ports Din_L]
set_drive 2.0 [get_ports Din_R]
